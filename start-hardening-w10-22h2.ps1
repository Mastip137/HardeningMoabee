...
Invoke-HardeningKitty -Mode Audit -Log -Report -FileFindingList ".\lists\finding_list_msft_security_baseline_windows_10_22h2_machine.csv"

# Audit des paramètres utilisateur
Invoke-HardeningKitty -Mode Audit -Log -Report -FileFindingList ".\lists\finding_list_msft_security_baseline_windows_10_22h2_user.csv"

######################
### Phase de patch ###
######################
#Renforcer les paramètres ordinateur
Invoke-HardeningKitty -Mode HailMary -Log -Report -FileFindingList ".\lists\finding_list_msft_security_baseline_windows_10_22h2_machine.csv"

#Renforcer les paramètres utilisateur
Invoke-HardeningKitty -Mode HailMary -Log -Report -FileFindingList ".\lists\finding_list_msft_security_baseline_windows_10_22h2_user.csv"